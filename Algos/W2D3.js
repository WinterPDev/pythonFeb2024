...
console.log(bracesValid(str5), "should equal", expected5);
console.log(bracesValid(str6), "should equal", expected6);
console.log(bracesValid(str7), "should equal", expected7);
